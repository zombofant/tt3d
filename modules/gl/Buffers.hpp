    ...
    public:
        virtual void bind() {
            ...
            if (nPos > 0) {
                ...
                glVertexPointer(nPos, glType, vertexSize, (const void*)(posOffset * sizeof(T)));
            }
            if (nColour > 0) {
                glEnableClientState(GL_COLOR_ARRAY);
                glColorPointer(nColour, glType, vertexSize, (const void*)(colourOffset * sizeof(T)));
